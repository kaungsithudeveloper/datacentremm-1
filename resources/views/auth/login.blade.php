                    ...
                    <div class="wrap-login100">
                        <form class="login100-form validate-form" method="POST" action="{{ route('login') }}">
                            ...
                            <div class="text-center pb-4">
                                <a href="{{ route('/') }}">
                                    <img src="{{ url('frontend/img/logo/logo-2-dark.png') }}"
                                        class="header-brand-img m-0" alt="">
                                </a>
                            </div>
                            ...
                            <div class="text-center pt-3">
                                <p class="text-dark mb-0">
                                    <a href="{{ route('password.request') }}" class="text-red ms-1" id="h-a">
                                        Forgot password?
                                    </a>
                                </p>
                            </div>
                            ...
                            <div class="text-center pt-3">
                                <p class="text-dark mb-0">Not a member?<a href="{{ route('register') }}"
                                        class="text-red ms-1" id="h-a">Sign UP</a></p>
                            </div>
