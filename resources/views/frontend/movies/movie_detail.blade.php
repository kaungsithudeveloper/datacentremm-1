    ...
    <div class="container  pb-5 mb-2 mb-md-4">
        <div class="row">
            ...
            <section class="col-lg-8">
                ...
                <div class="row">
                    <div class=" col-md-4 ">
                        <a class="product-list-thumb" href="{{ route('dc.movies.detail', $movie->id) }}"
                            id="movie-product-list-thumb">
                            <img src="{{ !empty($movie->photo) ? url('upload/product_images/' . $movie->photo) : url('upload/blog_images.png') }}"
                    ...
                    <div class=" col-md-8 mt-2">
                        ...
                        <h5 class="product-title">
                            <a href="{{ route('dc.movies.detail', $movie->id) }}" id="mname_{{ $movie->id }}">
                                {{ $movie->title }}
                            </a>
                        </h5>
                        ...
                        <div class="star-rating ml-2">
                            @php
                                $rating = $movie->rating; // Get the rating value from your model
                        ...
                        <div>
                            <a class="product-meta font-size-sm pb-1" id="h-a"
                                href="{{ route('dc.movies.years', ['release_date' => $movie->release_date]) }}">
                        ...
                        <div>
                            ...
                            <button type="button" class="btn btn-primary btn-sm mb-2"
                                onclick="addToCartDetails({{ $movie->id }})">
            ...
            <div class="modal-content" style="background-color: #0f2133;border: 0px">
                ...
                <div class="modal-header">
                    <h4 class="modal-title">
                        <a href="{{ route('dc.detail', $movie->id) }}" id="h-a">
                            {{ $movie->title }}
