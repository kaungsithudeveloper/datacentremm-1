                ...
                <div class="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-2 pb-sm-5">
                    <div class="d-flex flex-wrap">
                        <div class="order-lg-1 pr-lg-2 text-center text-lg-left">
                            <h1 class="h3 mb-0 text-white"> {{ $release_date }} Movie </h1>
                        </div>
                    </div>
                </div>
                <!-- Products grid-->
                ...
                <nav class="d-flex justify-content-between pt-2" aria-label="Page navigation">
                    ...
                    <ul class="pagination">
                        ...
                        @if ($movies->currentPage() > 4)
                            <li class="page-item">
                                <a class="page-link" href="{{ $movies->url(1) }}">1</a>
                            </li>
                            <li class="page-item disabled">
                        ...
                        @foreach (range(max($movies->currentPage() - 2, 1), min($movies->currentPage() + 2, $movies->lastPage())) as $page)
                        ...
                        @if ($movies->currentPage() < $movies->lastPage() - 3)
                            ...
                            <li class="page-item">
                                <a class="page-link"
                                    href="{{ $movies->url($movies->lastPage()) }}">{{ $movies->lastPage() }}</a>
                            </li>
                        @endif
                    </ul>
