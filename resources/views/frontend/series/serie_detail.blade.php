    ...
    <div class="container  pb-5 mb-2 mb-md-4">
        <div class="row">
            ...
            <section class="col-lg-8">
                ...
                <div class="row">
                    <div class=" col-md-4 ">
                        <a class="product-list-thumb" href="{{ route('dc.series.detail', $serie->id) }}"
                    ...
                    <div class=" col-md-8 mt-2">
                        ...
                        <h5 class="product-title">
                            <a href="{{ route('dc.series.detail', $serie->id) }}" id="mname_{{ $serie->id }}">
                                {{ $serie->title }}
                            </a>
                        </h5>
                        ...
                        <div class="star-rating ml-2">
                            @php
                                $rating = $serie->rating; // Get the rating value from your model
                        ...
                        <div>
                            <a class="product-meta font-size-sm pb-1" id="h-a"
                                href="{{ route('dc.series.years', ['release_date' => $serie->release_date]) }}">
                        ...
                        <div class="font-size-sm text-white">
                            Video Format : {{ $serie->video_format }}
                        </div>
