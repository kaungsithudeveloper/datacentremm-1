        ...
        <div class="row">
            ...
            <section class="col-lg-8">
                ...
                <div class="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-3 mb-lg-3">
                    <h6 class="font-size-base text-light mb-0">Update you profile details below:</h6><a
                        class="btn btn-primary btn-sm" href="{{ route('user.logout') }}"><i
                            class="czi-sign-out mr-2"></i>Sign
                        out</a>
                </div>
                <!-- Profile form-->
                <form method="post" action="{{ route('user.profile.update') }}" enctype="multipart/form-data">
                    @csrf
                    <h5 class="text-light mb-3">Update User Profile</h5>
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-light" for="account-fn">Name</label>
                                <input class="form-control" type="text" id="account-fn" name="name"
                                    value="{{ $user->name }}" required>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-light" for="account-ln">Email Address</label>
                                <input class="form-control" type="text" id="account-ln" name="email"
                                    value="{{ $user->email }}" required>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label class="text-light" for="account-phone">Phone Number</label>
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label class="text-light" for="account-phone">Address</label>
                    ...
                    <div class="row mt-2 mb-3">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                <label class="text-light" for="phone">Photo</label>
