                ...
                <div class="page-header">
                    ...
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Cast</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <form id="myForm" method="post" action="{{ route('casts.update') }}"
                                ...
                                <div class="card-body">
                                    <div class="">
                                            ...
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="gender" class="form-select" aria-label="Select gender">
                                                        <option value="male"
                                                            {{ $cast->gender == 'male' ? 'selected' : '' }}>Male</option>
                                                        <option value="female"
                                                            {{ $cast->gender == 'female' ? 'selected' : '' }}>Female
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Name"
                                                        name="birthday" value="{{ $cast->birthday }}">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="5" name="biography">{{ old('biography', $cast->biography) }}</textarea>
                                        </div>
