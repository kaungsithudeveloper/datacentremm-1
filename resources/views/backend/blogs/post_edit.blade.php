    ...
    <div class="main-content app-content mt-0">
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-8">
                        <form id="myForm" method="post" action="{{ route('posts.update') }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Name" name="title"
                                            autocomplete="name" value="{{ $blog->title }}">
                                    </div>

                                    <div class="form-group">
                                        <label for="description" class="form-label">Post Description :</label>
                                        <textarea name="description" id="myTextarea" class="content">{{ $blog->description }}</textarea>
                                    </div>
                                </div>
                            </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div class="form-group mb-4">
                                    ...
                                    <input type="text" name="post_tag_id" class="form-control" data-role="tagsinput"
                                        id="tags" value="{{ $tags->pluck('name')->implode(',') }}" required>
                                </div>
                            </div>
                        </div>
