        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Post Tags</h1>
                    <div>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card">
                            <form id="myForm" method="post" action="{{ route('posts.tags.update') }}">
                                @csrf
                                <div class="card-header">
                                    <h4 class="page-title">Edit Post Tags</h1>
                                </div>
                    ...
                    <div class="col-xl-8">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="page-title">All Post Tags</h1>
                            </div>
                                                ...
                                                <tr class="border-bottom">
                                                    ...
                                                    <td>
                                                        <div class="g-2 text-center">
                                                            ...
                                                            <a href="{{ route('posts.tags.edit', $posttag->id) }}"
                                                            ...
                                                            <a href="{{ route('posts.tags.delete', $posttag->id) }}"
