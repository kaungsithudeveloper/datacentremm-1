                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="page-header">
                            <h1 class="page-title"> All Role </h1>
                            <div>
                                <ol class="breadcrumb">
                                                    ...
                                                    <tr class="border-bottom">
                                                        ...
                                                        <td>
                                                            <div class="g-2 text-center">
                                                                <a href="{{ route('edit.roles',$role->id) }}" class="btn text-primary btn-sm" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                                                    <span class="fe fe-edit fs-14"></span>
                                                                </a>

                                                                <a href="{{ route('delete.roles',$role->id) }}" class="btn text-danger btn-sm" id="delete" data-bs-toggle="tooltip" data-bs-original-title="Delete">
