                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <a href="{{ route('add.permission') }}" class="btn btn-primary "> Create New Permission </a>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table id="responsive-datatable" class="table table-bordered text-nowrap mb-0 table-striped">
                                                <thead class="border-top">
                                                    <tr>
                                                        ...
                                                        <th class="bg-transparent border-bottom-0" style="width: 20%;"> Permission Name </th>
                                                        <th class="bg-transparent border-bottom-0"> Group Name</th>
                                                    ...
                                                    <tr class="border-bottom">
                                                        ...
                                                        <div class="d-flex">
                                                            <div class="ms-3 mt-0 mt-sm-2 d-block">
                                                                <h6 class="mb-0 fs-14 fw-semibold"> {{ $permission->name }} </h6>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <div  class="mt-0 mt-sm-3 d-block">
                                                                    <h6 class="mb-0 fs-14 fw-semibold"> {{ $permission->group_name }} </h6>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="g-2 text-center">
                                                                <a href="{{ route('edit.permission',$permission->id) }}" class="btn text-primary btn-sm" data-bs-toggle="tooltip" data-bs-original-title="Edit">
                                                                    <span class="fe fe-edit fs-14"></span>
                                                                </a>

                                                                <a href="{{ route('delete.permission',$permission->id) }}" class="btn text-danger btn-sm" id="delete" data-bs-toggle="tooltip" data-bs-original-title="Delete">
