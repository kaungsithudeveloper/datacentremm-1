    ...
    <div class="main-content app-content mt-0">
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <form id="myForm" method="post" action="{{ route('games.update') }}"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="myTextarea" class="content">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control mb-4" rows="4" name="short_descp">
                                            {{ $game->short_descp }}
                                        </textarea>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Name"
                                                    name="release_date" value="{{ $game->release_date }}">
                                            </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Name"
                                                    name="selling_price" value="{{ $game->selling_price }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="name" class="form-label">Discount Price :</label>
                                                <input type="text" class="form-control" placeholder="Name"
                                                    name="discount_price" value="{{ $game->discount_price }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-sm-9 text-secondary">
                                            <img id="showImage"
                                                src="{{ !empty($game->photo) ? url('upload/product_images/' . $game->photo) : url('upload/movie_images.png') }}"
